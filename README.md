...
- [Getting started](guides/Getting%20Started.md)
  ...
  - [Initialize a database using a Elixir releases](guides/Getting Started.md#initialize-a-database-using-a-elixir-releases)
  - [Using Postgres schemas](guides/Getting Started.md#using-postgres-schemas)
